...
function Donaciones () {
  const URL = 'https://back-vidasana-muetra.onrender.com/persona'
  ...
  const handleDeleteClick = (id) => {
    fetch(`https://back-vidasana-muetra.onrender.com/persona/${id}`, {
      method: 'DELETE'
    })
      .then((response) => {
  ...
  const handleUpdatePerson = async (updatedPerson) => {
    try {
      const response = await fetch(`https://back-vidasana-muetra.onrender.com/persona/${editingId}`, {
        method: 'PUT',
        headers: {
