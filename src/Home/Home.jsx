        ...
        <div className="container-cover">
          <div className="cover">
            ...
            <div className="img-cover ">
                <img src="/src/Home/Img/logoPropio.png" alt="" />
            </div>
            </div>
          </div>
                  ...
                  <div className="trust card-primary">
                        ...
                        <div className="container-trust container-box-card">
                            <div className="card-trust box-card-primary">
                              <img src="/src/Home/Img/contaminacion-planeta.png" alt="" />
                            ...
                            <div className="card-trust box-card-primary" id='cardPrincipal' >
                              <img src="/src/Home/Img/amor.png" alt="" />
                            ...
                            <div className="card-trust box-card-primary">
                              <img src="/src/Home/Img/donacion-en-linea.png" alt="" />
                              <h2>Donaciones</h2>
